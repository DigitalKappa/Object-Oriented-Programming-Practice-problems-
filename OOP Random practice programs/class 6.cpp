//Write a C++ program that simulates a simple banking system using a BankAccount class. The class should have private attributes for account number, account holder name, and balance. The program should allow the user to perform banking operations such as opening an account, depositing money, withdrawing money, and displaying account details.
#include<iostream>
#include<String.h>
using namespace std;
class Bankaccount{
